...
public class Templates {
	...
	static {
		...
		files.add("templates/database/DML MS_ACCESS_PATH.sql");
		files.add("templates/database/DML.sql");
		files.add("templates/logs/ganesha-log.txt");
		files.add("templates/pom.xml");
		files.add("templates/src/main/java/com/ganesha/basicweb/model/accesspath/AccessPath.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/model/activitylog/ActivityLog.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/model/FormBean.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/model/Item.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/model/module/Module.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/model/Pagination.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/model/TableEntity.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/model/Trackable.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/model/user/SimpleUser.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/model/usergroup/UserGroup.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/BusinessLogic.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/login/action/LoginExecuteAction.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/login/action/LoginExecuteAction.properties");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/login/form/LoginForm.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/login/HtmlMenuGenerator.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/login/logic/LoginBL.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/login/login-struts.xml");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/login/Privilege.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/login/PrivilegeUtils.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/login/usersession/SimpleSessionManager.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/login/usersession/SimpleUserSession.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/logout/action/LogoutExecuteAction.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/logout/action/LogoutMainAction.properties");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/logout/logout-struts.xml");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/module/action/ModuleMaintenanceAction.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/module/action/ModuleMaintenanceCreateAction.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/module/action/ModuleMaintenanceDeleteAction.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/module/action/ModuleMaintenanceMainAction.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/module/action/ModuleMaintenanceUpdateAction.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/module/ModuleBL.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/module/ModuleForm.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/module/modulemaintenance-struts.xml");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/module/package.properties");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/ModuleSession.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/resetusersession/action/ResetUserSessionMainAction.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/resetusersession/form/ResetUserSessionForm.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/resetusersession/logic/ResetUserSessionBL.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/resetusersession/package.properties");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/resetusersession/resetusersession-struts.xml");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/usergroupmaintenance/action/UserGroupMaintenanceAction.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/usergroupmaintenance/action/UserGroupMaintenanceCreateAction.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/usergroupmaintenance/action/UserGroupMaintenanceDeleteAction.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/usergroupmaintenance/action/UserGroupMaintenanceMainAction.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/usergroupmaintenance/action/UserGroupMaintenanceUpdateAction.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/usergroupmaintenance/HtmlPrivilegeTreeGenerator.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/usergroupmaintenance/package.properties");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/usergroupmaintenance/usergroupmaintenance-struts.xml");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/usergroupmaintenance/UserGroupMaintenanceBL.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/usergroupmaintenance/UserGroupMaintenanceForm.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/usermaintenance/action/UserMaintenanceAction.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/usermaintenance/action/UserMaintenanceCreateAction.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/usermaintenance/action/UserMaintenanceDeleteAction.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/usermaintenance/action/UserMaintenanceMainAction.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/usermaintenance/action/UserMaintenanceUpdateAction.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/usermaintenance/package.properties");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/usermaintenance/usermaintenance-struts.xml");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/usermaintenance/UserMaintenanceBL.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/modules/usermaintenance/UserMaintenanceForm.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/utility/AppContextManager.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/utility/CommonUtils.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/utility/GeneralConstants.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/utility/JSPUtils.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/utility/PageFail.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/utility/PropertiesConstants.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/utility/ServletStartUp.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/utility/SimpleFilter.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/utility/SimpleHttpSessionListener.java");
		files.add("templates/src/main/java/com/ganesha/basicweb/utility/SimpleSessionListener.java");
		files.add("templates/src/main/java/com/ganesha/core/exception/AppException.java");
		files.add("templates/src/main/java/com/ganesha/core/exception/GaneshaException.java");
		files.add("templates/src/main/java/com/ganesha/core/exception/UserException.java");
		files.add("templates/src/main/java/com/ganesha/core/SessionManager.java");
		files.add("templates/src/main/java/com/ganesha/core/User.java");
		files.add("templates/src/main/java/com/ganesha/core/UserSession.java");
		files.add("templates/src/main/java/com/ganesha/core/utils/MappingUtils.java");
		files.add("templates/src/main/java/com/ganesha/struts2/BaseAction.java");
		files.add("templates/src/main/java/com/ganesha/struts2/components/Component/Pagination.java");
		files.add("templates/src/main/java/com/ganesha/struts2/FormAction.java");
		files.add("templates/src/main/java/com/ganesha/struts2/views/jsp/PaginationTag.java");
